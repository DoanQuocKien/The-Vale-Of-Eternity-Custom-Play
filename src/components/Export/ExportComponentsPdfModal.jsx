          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', padding: '1.5rem' }}>
            ...
            <div style={{ padding: '0.75rem', background: 'rgba(139,92,246,0.05)', border: '1px solid rgba(139,92,246,0.2)', borderRadius: 'var(--radius-sm)', display: 'flex', flexDirection: 'column', gap: '0.6rem' }}>
              ...
              {(cmykStatus === null || cmykStatus === 'error') && (
                <button onClick={handleConvertToCmyk} style={{ padding: '0.5rem 0.75rem', background: 'linear-gradient(135deg, #7d3cee, #a856f7)', border: 'none', borderRadius: 'var(--radius-sm)', color: 'white', fontWeight: 700, cursor: 'pointer', fontSize: '0.8rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.4rem', boxShadow: '0 4px 12px rgba(139,92,246,0.25)' }}>
